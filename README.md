...
- **菜单栏标题**：开盘标的轮播：指数（美股含盘前 04:00–09:30、盘后 16:00–20:00 纽约时间）、贵金属现货（纽约时间周日 18:00 至周五 17:00，每日 17:00–18:00 休息）、虚拟货币（24 小时）；右击自选再选固定某一标的；全部休市时显示「休市」
...
- **整理自选**：右击自选可选固定/取消固定；右击进入排序，可拖动、上移、下移、删除
